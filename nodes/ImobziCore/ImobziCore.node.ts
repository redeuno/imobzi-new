		...
		properties: [
			...
			// ==================== TEAM OPERATIONS ====================
			{
				...
				options: [
					...
					{ name: 'Get All', value: 'getAll', action: 'Get all teams' },
			...
			// ==================== DOCUMENT OPERATIONS ====================
			{
				...
				options: [
					...
					{ name: 'Get All', value: 'getAll', action: 'Get all documents' },
			...
			// ==================== CALENDAR OPERATIONS ====================
			{
				...
				options: [
					...
					{ name: 'Get All', value: 'getAll', action: 'Get all calendar items' },
			...
			// ==================== CALENDAR TYPE OPERATIONS ====================
			{
				...
				options: [
					...
					{ name: 'Get All', value: 'getAll', action: 'Get all calendar types' },
			...
			// ==================== TIMELINE OPERATIONS ====================
			{
				...
				options: [
					...
					{ name: 'Get All', value: 'getAll', action: 'Get all timeline items' },
			...
			// ==================== NOTIFICATION OPERATIONS ====================
			{
				...
				options: [
					...
					{ name: 'Get All', value: 'getAll', action: 'Get all notifications' },
			...
			// ==================== MEDIA SOURCE OPERATIONS ====================
			{
				...
				options: [
					...
					{ name: 'Get All', value: 'getAll', action: 'Get all media sources' },
			...
			// ==================== REVISION OPERATIONS ====================
			{
				...
				options: [
					...
					{ name: 'Get All', value: 'getAll', action: 'Get all revisions' },
			...
			// ==================== PARAMETER OPERATIONS ====================
			{
				...
				options: [
					{ name: 'Get All', value: 'getAll', action: 'Get parameters' },
				],
				default: 'getAll',
			},
			...
			// ==================== CHAT OPERATIONS ====================
			{
				...
				options: [
					...
					{ name: 'Get All', value: 'getAll', action: 'Get all chat conversations' },
				],
				default: 'getAll',
			},
			...
			// ==================== MEASURE OPERATIONS ====================
			{
				...
				options: [
					...
					{ name: 'Get All', value: 'getAll', action: 'Get all measures' },
				],
				default: 'getAll',
			},
			...
			// ==================== USER BILLING OPERATIONS ====================
			{
				...
				options: [
					{ name: 'Get All', value: 'getAll', action: 'Get user billing' },
				],
				default: 'getAll',
			},
			...
			// ==================== REALTOR OPERATIONS ====================
			{
				...
				options: [
					{ name: 'Get All', value: 'getAll', action: 'Get all realtors' },
				],
				default: 'getAll',
			},
			...
			// ==================== CREDIT ANALYSIS OPERATIONS ====================
			{
				...
				options: [
					...
					{ name: 'Get All', value: 'getAll', action: 'Get all credit analyses' },
